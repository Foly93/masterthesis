...
def evaluate_model(outer_true,outer_pred,outer_prob):
    ...
    pyplot.legend()
    pyplot.savefig("../_output/fp_602340_agg_auc.svg", dpi=300)
    ...
    pyplot.legend()
    pyplot.savefig("../_output/fp_602340_avr_auc.svg", dpi=300)
    
    # write the aforementioned metrics into a file
    f = open("../_output/fp_602340_analysis.txt","w+")
...
df = pd.read_csv('../../02-CorrectingAssays/_output/cp_602340.csv')
