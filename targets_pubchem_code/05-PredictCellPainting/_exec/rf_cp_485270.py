...
def evaluate_model(outer_true,outer_pred,outer_prob):
    ...
    pyplot.legend()
    pyplot.savefig("../_output/fp_485270_agg_auc.svg", dpi=300)
    ...
    pyplot.legend()
    pyplot.savefig("../_output/fp_485270_avr_auc.svg", dpi=300)
    
    # write the aforementioned metrics into a file
    f = open("../_output/fp_485270_analysis.txt","w+")
...
df = pd.read_csv('../../02-CorrectingAssays/_output/cp_485270.csv')
