...
# #### 1. Read the Input
# - input files are being found in step 2 dirctory and are named after their respective 2156
# - the original notebook was processing the file cp_2156.csv but that is subject to change
...
df.to_csv('../_output/fp_2156.csv',index=False)

# pd.read_csv('../_output/fp_2156.csv') # only uncomment to check if the output was done correctly
