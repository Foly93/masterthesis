...
# #### 1. Read the Input
# - input files are being found in step 2 dirctory and are named after their respective 651658
# - the original notebook was processing the file cp_651658.csv but that is subject to change
...
df.to_csv('../_output/fp_651658.csv',index=False)

# pd.read_csv('../_output/fp_651658.csv') # only uncomment to check if the output was done correctly
